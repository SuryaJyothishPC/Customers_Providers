...
class serviceRegister : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val name = findViewById<EditText>(R.id.name_reg_srv)
        val phno = findViewById<EditText>(R.id.reg_phn_srv)
        val send = findViewById<Button>(R.id.reg_send_srv)
        val otp = findViewById<EditText>(R.id.otp_reg_srv)
        val verify = findViewById<Button>(R.id.verify_reg_srv)
    ...
    private fun saveUserData(userId: String) {
        val name = findViewById<EditText>(R.id.name_reg_srv).text.toString().trim()
        val phoneNumber = findViewById<EditText>(R.id.reg_phn_srv).text.toString().trim()
